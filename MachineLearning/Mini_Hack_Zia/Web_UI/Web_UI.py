...
if upload_file is not None:
    ...
    if st.button("Predict the uploaded file"):
        ...
        # st.download_button(label="Download Prediction",data=df.to_csv(index=False),file_name="Prediction.csv",mime="text/csv",on_click=on_download)
...
if st.session_state.download_message:
    st.write("File Downloaded successfully!!!")
